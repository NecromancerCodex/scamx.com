...
export const StartScreen: React.FC = () => {
  ...
  const handleVoicePhishingGame = () => {
    playButtonClickSound();
    router.push('/game/stage-select');
  };

  const handleScamAgent = () => {
    playButtonClickSound();
  ...
  return (
    <div className="relative w-full h-screen bg-gradient-to-b from-gray-300 via-gray-200 to-gray-100 overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-1/3 h-full bg-gray-500/30"></div>
        <div className="absolute top-0 left-1/3 w-1/4 h-3/4 bg-gray-600/30"></div>
        <div className="absolute top-0 right-0 w-1/3 h-2/3 bg-gray-400/30 rounded-tl-3xl"></div>
      ...
      <div className="relative z-10 flex flex-col gap-6">
        <button
          onClick={handleVoicePhishingGame}
